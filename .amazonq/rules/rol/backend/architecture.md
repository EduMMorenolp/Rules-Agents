# AccessAI Backend - Architecture Rules
...
```javascript
// services/authService.js
import { User, Alert, Device, AccessLog } from '../models/index.js';
...
Esta arquitectura garantiza desarrollo ágil y producción segura del backend AccessAI.